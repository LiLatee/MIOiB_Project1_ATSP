...
## Wczytanie danych
```{r load_data}
results <- read.table("./../results/results_SW_wzor_0001.csv", head=TRUE, sep=",")
algs_symbols <- list(Greedy="G", Steepest="S", SimpleHeur="H", Random="R", RandomWalk="RW", SW="SW")
...
colors = c(G="#ff0000", S="#04ff00", R="#0004ff", RW="#ff9d00", H="#ff00fb", SW="#42f5e3")
```
