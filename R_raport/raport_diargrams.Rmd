...
## Wczytanie danych
```{r load_data}
results <- read.table("./../results/results_SW_TS_10.csv", head=TRUE, sep=",")
algs_symbols <- list(Greedy="G", Steepest="S", SimpleHeur="H", Random="R", RandomWalk="RW", SW="SW", Tabu="TS")
...
# filterek
# algs = c("G", "S", "H", "TS", "SW")
# results <- filter(results, algName %in% algs)
#######################
...
colors = c(G="#ff0000", S="#04ff00", R="#0004ff", RW="#ff9d00", H="#ff00fb", SW="#42f5e3", TS="#d1a924")
```
