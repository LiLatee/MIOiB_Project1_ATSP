...
gp <- summarize(gp, diff=mean((result-optimalResult)/optimalResult), std=sd((result-optimalResult)/optimalResult), nOfCities=mean(nOfCities))
knitr::kable(gp)
...
gp <- group_by(results, algName, setName)
gp <- summarize(gp, diff=min((result-optimalResult)/optimalResult), std=sd((result-optimalResult)/optimalResult), nOfCities=mean(nOfCities))
...
gp <- group_by(results, algName, setName)
gp <- summarize(gp, diff=max((result-optimalResult)/optimalResult), std=sd((result-optimalResult)/optimalResult), nOfCities=mean(nOfCities))
